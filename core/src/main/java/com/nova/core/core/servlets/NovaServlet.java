...
@Component(service = { Servlet.class }, property = {
        ...
        "sling.servlet.resourceTypes=" + "nova/components/page",
        SLING_SERVLET_PATHS + "=" + "/nova/r5servlet",
        "sling.servlet.selectors=" + "nova",
        "sling.servlet.selectors=" + "ds",
        SLING_SERVLET_EXTENSIONS + "=" + "xml",
        "sling.servlet.extensions" + "=" + "txt"
})
public class NovaServlet extends SlingAllMethodsServlet {
    private static final Logger LOG = LoggerFactory.getLogger(NovaServlet.class);
